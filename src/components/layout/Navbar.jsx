  ...
  return (
    ...
    >
      <div
        ...
        className="max-w-7xl mx-auto px-6 xl:px-10 flex items-center justify-between"
      >
        ...
        <div className="hidden lg:flex items-center gap-4 xl:gap-6">
          ...
          <a
            ...
            className="hover:opacity-90 text-white text-sm xl:text-base font-semibold
              px-5 xl:px-6 py-2.5 xl:py-3 rounded-lg transition-opacity"
          >
            Get a Quote
          </a>
        ...
        <div className="lg:hidden flex items-center gap-2">
          ...
          <a
            ...
            className="w-9 h-9 flex items-center justify-center rounded-lg
              text-graphite dark:text-white
              hover:text-brand-green hover:bg-black/5 dark:hover:bg-white/5
              transition-colors"
          >
      ...
      >
        <div className="px-6 pb-6 pt-4 flex flex-col items-center gap-4">
          ...
          <a
            ...
            onClick={() => setMenuOpen(false)}
            style={{ backgroundColor: t.brand.primary }}
            className="hover:opacity-90 text-white text-sm font-semibold px-5 py-2.5 rounded-lg text-center transition-opacity w-full max-w-xs"
          >
            Get a Quote
          </a>
        </div>
